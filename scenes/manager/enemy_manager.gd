...
func get_spawn_position():
	...
	var random_direction = Vector2.RIGHT.rotated(randf_range(0, TAU)) #rotate the vector to a random position between 0 and 2pi
...
func _on_arena_difficulty_increased(arena_difficulty : int):
	...
	if arena_difficulty == 6: #30 seconds in
